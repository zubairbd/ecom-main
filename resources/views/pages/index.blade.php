                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            ...
                            <li><a href="{{$row->product_slug}}">{{$row->category_name}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                ...
                <div class="categories__slider owl-carousel">
                    ...
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{asset($product->image_one)}}">
                            <h5><a href="{{$product->product_slug}}">{{$product->product_name}}</a></h5>
                        </div>
                    </div>
                    @endforeach
                </div>
                    ...
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="{{asset($product->image_one)}}">
                            <ul class="featured__item__pic__hover">
                                ...
                                <li><form action="{{url('add/to-cart/'.$product->id)}}" method="post">
                                    @csrf
                    ...
                    <div class="latest-product__text">
                        ...
                        <div class="latest-product__slider owl-carousel">
                            <div class="latest-prdouct__slider__item">
                                @foreach($lts_prd as $product)
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="{{asset($product->image_one)}}" style="height: 110px; width: 110px;" alt="">
                                    </div>
