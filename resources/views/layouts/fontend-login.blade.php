...
{{--                            <input type="text" name="" class="form-control unicase-form-control text-input" id="exampleInputEmail1">--}}
{{--                        </div>--}}
                        <div class="form-group">
...
<script src="{{asset('fontend')}}/switchstylesheet/switchstylesheet.html"></script>
