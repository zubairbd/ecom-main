        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
                    ...
                    <div class="dropdown dropdown-cart"> <a href="{{url('cart')}}" class="dropdown-toggle lnk-cart" 2data-toggle="dropdown">
...
{{--                                    <div class="row">--}}
{{--                                        <div class="col-xs-4">--}}
{{--                                            <div class="image"> <a href="detail.html"><img src="{{ asset($cart->product->image_one) }}" alt=""></a> </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="col-xs-7">--}}
{{--                                            <h3 class="name"><a href="index8a95.html?page-detail">{{ $cart->product->product_name }}</a></h3>--}}
{{--                                            <div class="price">{{ $cart->price }}</div>--}}
{{--                                        </div>--}}
{{--                                        <div class="col-xs-1 action"> <a href="{{ url('cart/destroy/'.$cart->id) }}"><i class="fa fa-trash"></i></a> </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                @endforeach--}}
{{--                                <!-- /.cart-item -->--}}
...
{{--                                    <div class="clearfix"></div>--}}
{{--                                    <a href="{{ url('cart') }}" class="btn btn-upper btn-primary m-r-5  m-t-20">Cart</a>--}}
{{--                                    <a href="{{ url('checkout') }}" class="btn btn-upper btn-primary  m-t-20">Checkout</a> </div>--}}
{{--                                <!-- /.cart-total-->--}}
