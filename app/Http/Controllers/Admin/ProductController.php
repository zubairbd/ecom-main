...
class ProductController extends Controller
{
    ...
    public function storeProduct(Request $request){
        ...
        Image::make($imag_one)->resize(270,270)->save('fontend/assets/images/products/upload/'.$name_gen);
        $img_url1 = 'fontend/assets/images/products/upload/'.$name_gen;

        $imag_two = $request->file('image_two');
        $name_gen = hexdec(uniqid()).'.'.$imag_two->getClientOriginalExtension();
        Image::make($imag_two)->resize(270,270)->save('fontend/assets/images/products/upload/'.$name_gen);
        $img_url2 = 'fontend/assets/images/products/upload/'.$name_gen;

        $imag_three = $request->file('image_three');
        $name_gen = hexdec(uniqid()).'.'.$imag_three->getClientOriginalExtension();
        Image::make($imag_three)->resize(270,270)->save('fontend/assets/images/products/upload/'.$name_gen);
        $img_url3 = 'fontend/assets/images/products/upload/'.$name_gen;
    ...
    public function updateImage(Request $request){
        ...
        if ($request->has('image_one') && $request->has('image_two')) {
            ...
            $name_gen = hexdec(uniqid()).'.'.$imag_one->getClientOriginalExtension();
            Image::make($imag_one)->resize(270,270)->save('fontend/assets/images/products/upload/'.$name_gen);
            $img_url1 = 'fontend/assets/assets/product/upload/'.$name_gen;
    ...
    public function Inactive($product_id){
        ...
        return Redirect()->back()->with('inactive','Product inactive');
    }
    ...
    public function Active($product_id){
        ...
        return Redirect()->back()->with('active','Product Activated');
    }
}
